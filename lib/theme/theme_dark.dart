...
class ThemeDark {
  static final ThemeData themeData = ThemeData(
    scaffoldBackgroundColor: ThemeDark.surface0,
    brightness: Brightness.dark,
    appBarTheme: AppBarTheme(
      backgroundColor: ThemeDark.surface1,
    ),
  );
  ...
  static Color brand4 = const Color(0xFF7EAEE6);
  static Color brand5 = const Color(0xFF558ED9);
  static Color brand6 = const Color(0xFF2F6DCD);
  static Color brand7 = const Color(0xFF1E50A6);
  ...
  static Color fill5 = const Color(0xFF00050E);
  static Color fill6 = const Color(0xFF262626);
  static Color fill7 = const Color(0xFF262626);
  ...
  static Color text1 = const Color(0xFFF0F1F5);
  ...
  static Color line3 = const Color(0xFF41444A);
  ...
  static Color black12 = const Color(0x1E141414);
